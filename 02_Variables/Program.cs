...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //double number; // ondalık sayıları göstermek için kullanılır.

            //number = 4.85;  // Kodda nokta kullanılır, konsolda virgül olarak gösterilir.
            ...
            //    " - Gramaj: " + appleGram + " Kg" + " - Toplam Tutar: " + appleTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Portakal - " + "Birim Fiyat: " + orangePrice + " TL" + 
            //    " - Gramaj: " + orangeGram + " Kg" + " - Toplam Tutar: " + orangeTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyat: " + strawberryPrice + " TL" + 
            //    " - Gramaj: " + strawberryGram + " Kg" + " - Toplam Tutar: " + strawberryTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyat: " + potatoPrice + " TL" + 
            //    " - Gramaj: " + potatoGram + " Kg" + " - Toplam Tutar: " + potatoTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Domates - " + "Birim Fiyat: " + tomatoPrice + " TL" + 
            //    " - Gramaj: " + tomatoGram + " Kg" + " - Toplam Tutar: " + tomatoTotalPrice + " TL");
            ...
            //char içine sembol atanabilir
            //sembol ' ' içinde olmalı
            //karakter veya sembol
            ...
            //passengerName = Console.ReadLine();   // Klavyeden veri girişi yapmamızı sağlar.
            ...
            //    " - Yolcu İkametgahı: " + passengerDistrict + "/" + passengerCity +
            ...
            //exam1 = double.Parse(Console.ReadLine());   // Klavyeden ondalık sayı girerken araya nokta değil, virgül konulur.
            ...
            //gender = char.Parse(Console.ReadLine());   // Bir karakter uzunluğunda olmalı.
